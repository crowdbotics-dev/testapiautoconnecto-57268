...
## Project Structure
    ...
    ├── testapiautoconnecto_57268  # Django project configurations
...
1. Clone this repo and `cd testapiautoconnecto_57268`
...
2. Clone this repo and `cd testapiautoconnecto_57268`
